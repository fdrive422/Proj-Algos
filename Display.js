...
class SLL {                 // Class single linked list node (itself)
    ...
    // Display the valie of all the notes in the list
    display() {
        var listStr = "";              // empty string that wil lcontain the values of the list
        if (this.head == null) {
            return "";                 // will return an empty list if no value to console.log

        }
        listStr += this.head.value;     // will contactenate first galue in the list
